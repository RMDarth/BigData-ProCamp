...
if [[ -z "$OUTPUT_PATH" ]];
then
  OUTPUT_PATH="/bdpc/hadoop/lab6/popularAirports"
fi
...
spark-submit --master yarn \
             ...
             --class com.github.rmdarth.bdpclab6.PopularAirportsDF \
             sparkdf1_2.12-1.0.jar "$INPUT_PATH" "$AIRPORTS_PATH" "$OUTPUT_PATH"
